  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'glow-md': '0 0 20px hsla(var(--primary), 0.4)',
        'glow-lg': '0 0 30px hsla(var(--primary), 0.5)',
        'glow-accent': '0 0 20px hsla(var(--accent), 0.4)',
        'inner-glow': 'inset 0 0 20px hsla(var(--primary), 0.2)',
      },
    },
  },
  plugins: [

...
import { Transaction, Category, Budget, Tag, AiCategorizationFeedback } from '@database/entities';

@Module({
  imports: [TypeOrmModule.forFeature([Transaction, Category, Budget, Tag, AiCategorizationFeedback])],

...
import { DateRangeQueryDto, CategoryAnalyticsQueryDto, AccountAnalyticsQueryDto } from './dto/analytics.dto';
...
export class AnalyticsController {
  ...
  @ApiResponse({ status: 200, description: 'Returns spending grouped by categories with percentages' })
